$(document).ready(function()
{
   ...
   $(document).on("click", ".page button", function()
   {
        ...
        $(".table-content").load("edit_staff/edit_staff_ajax.php", {
   ...
   $(document).on("click", ".fa-edit, .modal-head button", function()
   {
        ...
        $(".modal-body").load("edit_staff/display_and_update.php", {
            id:id, c:choice_add
        });
   });
   ...
   $(document).on("change", ".modal-body .paragraph .input input, select", function()
   {
        ...
        let rl = $("select[name = 'role']").val();
        console.log(rl);
        $(".modal-body").load("edit_staff/display_and_update.php", {
            id:id, gd:gd, fn:fn, pn,pn, add:add, st:st, ct:ct, pc:pc, rl:rl, c:choice_add
        });
