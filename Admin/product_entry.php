	...
	<div class = "body-content">
		...
		?>
			<div class = "box">
				...
				<div>
					<p id = "user-count" class = "count"><?php echo $proentry?></p>
					<p>Total Prouduct</p>
				</div>
			</div>
			...
			<div class = "box">
				<div class ="yqty">
				<i class ="fa fa-check-circle" style="font-size:27px;"></i>
					
				</div>
				<div>
					<p id = "items-count" class = "count"><?php echo $qyyentry?></p>
					<p>In Store</p>
			...
			<div class = "box">
				...
				<div>
				<p id = "sales-count" class = "count"><?php echo $qyentry?></p>
				<p>Out Of Store</p>
				</div>
			</div>
		</div>
					...
					<form  name="shoesform"  class="shoesform" method="post" action="" >
						...
						<div class="block" >
							<div class=row>
								...
								{
								?>
									<option value = "<?php echo $row['Shoes_ID']?>"><?php echo $row['Shoes_Name']?></option>
								<?php
								}
								?>
								</select>
						...
						<div class="block" >
							<div class=row>
								...
								<input type="number" required="" name="sqty" min="1" max="10" onKeyDown="return false">
							</div>
						</div>
			...
			<div class="sizetable" id="sizetable" >
				...
				<table >
					<tr class="sione" >
						...
						{
						?>
						<td  class="sictwo" ><?php echo $row['Size_ID']?></td>
						<?php
						}
						?>	
					</tr>	
					...
					<tr>
						...
						{
						?>
						<td ><span class="actsifunction" >&nbsp;</span><input type="hidden" value ="<?php echo $row["Size_ID"];?>"></td>
						<?php
						}
						?>
					</tr>
