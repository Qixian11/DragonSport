...
<link rel="stylesheet" type="text/css" href="edit_user/edit_user.css">
...
<script src = "edit_user/edit_user.js" type="text/javascript"></script>
<script src="edit_user/jquery.mask.js"></script>
</head>
    ...
    <div class = "body-content">
        <div class="user-table">
            ...
            <div class = "table-header">
                ...
                <div class = "add-btn">
                    <button class = "gear"><i class="lni lni-cog"></i></button>
                    <div>
            ...
            <div class = "table-content">
                <div class = "table">
                    ...
                    <?php
                        ...
                        $result = mysqli_query($connect, "SELECT * FROM user LIMIT 8");
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <span class = "operation">&nbsp;</span><input type="hidden" value = "<?php echo $row['user_id']?>"></td>
                        </tr>
                    <?php
                        }
                    ?>
