...
<?php
$brands_result = mysqli_query($connect, "SELECT * FROM category_brands LIMIT 8");
$count_brands_result = ceil(mysqli_num_rows(mysqli_query($connect, "SELECT * FROM category_brands")) / 8);//for page

$types_result = mysqli_query($connect, "SELECT * FROM category_types LIMIT 8");
$count_types_result = ceil(mysqli_num_rows(mysqli_query($connect, "SELECT * FROM category_types")) / 8);//for page
?>
    ...
    <div class = "body-content">
        <div class = "category">
            <div class = "category-head">
                <h3>Brands</h3>
                <button id = "brand-add">Add</button>
            </div>
            <div class = "category-body" id = "b-category-body">
                <table>
                    <tr>
                        <th>ID</th>
                        <th>Brands Name</th>
                ...
                <div class = "page">
                    ...
                    {
                        for($i = 0; $i < $count_brands_result; $i++)
                        {
                        ?>
                            <div><button value = "<?php echo $i+1?>"><?php echo $i+1?></button></div>
                        <?php
            ...
            <div class = "modal" id = "brand-modal">
                <div class = "modal-body">
                    ...
                    <div class = modal-content>
                        <div class = "input">
                            <p><input type="text" name = "type" placeholder = "Insert New Brands Here"></p>
            ...
            <div class = "modal del-modal" id = "del-brand-modal">
                <div class = "modal-body">
        ...
        <div class = "category">
            ...
            <div class = "category-body" id = "t-category-body">
                <table>
                    <tr>
                        <th>ID</th>
                        <th>Types Name</th>
                ...
                <div class = "page">
                    ...
                    {
                        for($i = 0; $i < $count_types_result; $i++)
                        {
                        ?>
                            <div><button value = "<?php echo $i+1?>"><?php echo $i+1?></button></div>
                        <?php
            ...
            <div class = "modal" id = "type-modal">
                <div class = "modal-body">
                    ...
                    <div class = modal-content>
                        <div class = "input">
                            <p><input type="text" name = "type" placeholder = "Insert New Types Here"></p>
                            <p class = "error" id = "t-error">&nbsp;</p>
                        </div>
                        <div class = "submit">
                            <input type="button" name = "type_submit" value = "Insert">
                        </div>
                    </div>
                </div>
            </div>
            <div class = "modal del-modal" id = "del-type-modal">
                <div class = "modal-body">
                    <div class="delete-icon">
                        <i class="lni lni-warning"></i>
                    </div>
