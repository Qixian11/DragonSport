                        ...
                        <table>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr id="data">
                                    ...
                                    <td>
                                        <div class="shdec ">
                                            <?php echo $row["Shoes_Description"]; ?>
                                        </div>
                                    </td>
                                    <td><span class="actionfucntion">&nbsp;</span><input type="hidden"
                                            value="<?php echo $row["Shoes_ID"]; ?>"></td>
                                </tr>
                            <?php
                            }
                            ?>
            ...
            <div class="profile">
                ...
                <div class="profile-body">
                    <form method="post">
                        ...
                        <p class=profile-body-2><input type="text" name="fullname"
                                value="<?php echo $admin["fullname"] ?>"></p>


                        <p class=profile-body-1>Gender</p>
                        <p class=profile-body-2><input type="text" name="gender" value="<?php echo $admin["gender"] ?>">
                        </p>

                        <p class=profile-body-1>Phone_num</p>
                        <p class=profile-body-2><input type="tel" name="phone" value="<?php echo $admin["phone_num"] ?>">
                        </p>

                        <p class=profile-body-1>Street</p>
                        <p class=profile-body-2><input type="text" name="street" value="<?php echo $admin["street"] ?>">
                        </p>
                        ...
                        <p class=profile-body-2><input type="text" name="state" value="<?php echo $admin["state"] ?>">
                        </p>


                        <p class=profile-body-1>Postal code</p>
                        <p class=profile-body-2><input type="text" name="postal"
                                value="<?php echo $admin["postal_code"] ?>"></p>
                        ...
                        <div class="chg-box">
                            ...
                            <div class="chg-body">
                                <form method="post">
                                    ...
                                    <p><input type="password" name="cpassword" placeholder="Current Password"
                                            required /></p>
