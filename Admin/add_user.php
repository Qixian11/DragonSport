...
<link rel="stylesheet" type="text/css" href="add_user/add_user.css">
...
<script src = "add_user/add_user.js" type="text/javascript"></script>
</head>
...
<div class = "modal">
    <div class = "modal-container">
        ...
        <div class = "modal-body">
            <p class = "input"><span>Username :</span><input type="text" name = "username"></p>
            <p id = "e-uname" class = "error"></p>
            <p class = "input"><span>Full Name :</span><input type="text" name = "fullname"></p>
