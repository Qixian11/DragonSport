...
{
	$email=$_POST["email"];
	$query=mysqli_query($connect,"SELECT * FROM user where	user_email='$email'");

	if(mysqli_num_rows ($query)==1)
	{
		$subject = "FORGOT PASSWORD Verification link";
			
			$message ="Your activation link is: http://localhost/fyp/Client/forgotpass.php?email&emails=$email";
...
<?php	
	...
	?>
		<script>
			...
			location.href = "forgotpass mail.php";
